...
def mainreceipt():
    ...
    if request.method == 'GET':
        cursor = connection.cursor()
        print('is customer still in session? ',session)
    ...
    if ses != None:
        ...
        #    return render_template("pokemon.html", len = len(updates), dates = updates, order_id = order_id)
        ...
        render_template('receipt2.html', order_id = order_id)
...
def register():
    if request.method == 'GET':
        ...
        if not (email and customer_name and customer_pass and repass) :
            ...
            cursor = connection.cursor()
            query = ("insert into customers"+"(customer_id, email, customer_name, customer_pass, login_session, verification, enter) "+
    ...
    if request.method == 'GET':
        ...
        # Label the results
            ...
            # Draw a box around the face
                ...
                # cv2.imwrite('/home/moon/Desktop/Ui_mix/chosenones/1/customers/'+email+'/'+picnum+'.jpg', crop_img)
        ...
        # if num_files < 1:
            # os.remove('/home/moon/Desktop/chosenones/1/customers/'+customer_name)
        ...
        # else:
            # return "Welcome, "+customer_name+". Please click a button below to proceed your registration.."
        #update ftp################3
        # ftp = FTP()
        ...
        # picname = picnum,'.jpg'
        # path = '/home/moon/Desktop/Ui_mix/chosenones/1/customers/',picname
...
if __name__ == '__main__':
    ...
    # app.run(host='192.168.0.67', port=9899, debug=True) 
